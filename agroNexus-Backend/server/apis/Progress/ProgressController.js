...
add = (req, res) => {
    ...
    if (formData.progressStage === "Maturity & Harvesting") {
    if (!formData.harvestDate) {
        validation += "Harvest Date is required "
    }
    if (!formData.harvestYield) {
        validation += "Harvest Yield is required "
    }
}
    ...
    if (!!validation) {
        ...
        //duplicacy     
        ProgressModel.findOne({ bookingId: formData.bookingId,    progressStage: formData.progressStage })
            .then(async (progressData) => {
                if (!progressData) {
                    ...
                    progressObj.harvestDate = formData.harvestDate
                    progressObj.harvestYield = formData.harvestYield
