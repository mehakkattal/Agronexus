                ...
                if (!bookingData) {
                    ...
                    bookingObj.save()
                        ...
                        .then(async (bookingData) => {
                            ...
                            // LAND FIND
                            let landData = await LandModel.findById(bookingData.landId)

                            // FARMER FIND
                            let farmerData = await UserModel.findById(landData.farmerId)

                            // USER FIND
                            let userData = await UserModel.findById(req.decoded.userId)

                            // SEND MAIL TO FARMER
                            await sendMail(
                                farmerData.email,
                                "New Booking Request",
                                `Hello ${farmerData.name},

A new booking has been added by ${userData.name}.
                ...
                if (!bookingData) {
                    ...
                    bookingData.save()
                        ...
                        .then(async (bookingData) => {
                            ...
                            // USER FIND
                            let userData = await UserModel.findById(bookingData.userId)
...
Your booking has been approved by farmer.
`
                                )
...
Your booking has been rejected by farmer.
`
                                )
