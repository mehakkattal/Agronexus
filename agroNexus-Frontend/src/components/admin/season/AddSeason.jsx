...
export default function AddSeason() {
    ...
    return (
        ...
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Add Season</h1>
...
<div className="container-xxl py-6">
  <div className="container">
    ...
    <div
      ...
      style={{ maxWidth: 500 }}
    >
      <h1 className="display-6 mb-3">Add Season</h1>
    </div>
      ...
      <div className="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
        ...
        <form onSubmit={handleSubmit(handleForm, handleError)}>
          <div className="row g-3">
            ...
            {/* Image */}
            <div className="col-md-12">
              <label className="form-label">Season Image</label>
              <input
                type="file"
                accept="image/*"
                className="form-control"
